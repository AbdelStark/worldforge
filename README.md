...
| [`voyage`](https://abdelstark.github.io/worldforge/providers/voyage/) | `scaffold` | scaffold | `VOYAGE_API_KEY` | host supplies a Voyage AI API key via the VOYAGE_API_KEY environment variable |
